...
namespace CafeteriaDB.Clases
{
    public class Proveedor
    {
        ...
        public bool Delete()
        {
            ...
            {
                conexion.Conectar();
                SqlCommand cmd = new SqlCommand("UPDATE Proveedor SET Activo = 0 WHERE ID=@id", conexion.ObtenerConexion());
                cmd.Parameters.AddWithValue("@id", id);
                cmd.ExecuteNonQuery();
                conexion.Desconectar();
                return true;
        ...
        public DataTable SelectAll()
        {
            ...
            {
                conexion.Conectar();
                SqlCommand cmd = new SqlCommand("SELECT * FROM Proveedor WHERE Activo = 1", conexion.ObtenerConexion());
